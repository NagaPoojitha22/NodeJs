    ...
    */
    ...
    if (req.url === '/') {
        ...
        async function main(){
             ...
             */
            const uri ="mongodb+srv://nkond10:konda@cluster0.qrm1jld.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
        ...
        async function findsomedata(client ){
            const cursor = client.db("dogdb").collection("Dogbreed").find({});
...
server.listen(8511, () => console.log("yay my server is running"));